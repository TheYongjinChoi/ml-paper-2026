# 04_cv.py — grid search + hold-out evaluation
# The notebook repeated this loop for RF / XGBoost / LightGBM / DNN / CatBoost.
# The body is identical to the notebook; only the model and param grid vary,
# so those are passed in as arguments.
